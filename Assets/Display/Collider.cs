...
class Collider
{
    ...
    public bool IsColliding(Piece piece, List<List<SquareColor>> colors, List<int> move, Piece pieceToignore)
    {
        foreach (List<int> cord in new List<List<int>> { piece.cord1, piece.cord2, piece.cord3, piece.cord4 })
        {
            ...
            bool isSame = false;
            foreach (List<int> cord2 in new List<List<int>> { pieceToignore.cord1, pieceToignore.cord2, pieceToignore.cord3, pieceToignore.cord4 })
            {
